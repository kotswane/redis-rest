...
import("./swagger_output.json", { assert: { type: "json" } });
import {requestToken,generateToken,deleteToken,healthCheck} from "./controller/controller.js";

export const app = express();
//const PORT = process.env.TOKEN_API_SERVER_PORT;
const PORT = 5000;
